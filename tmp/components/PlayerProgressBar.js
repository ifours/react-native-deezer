...
class PlayerProgressBar extends Component {
  ...
  _updateProgress(value) {
    ...
    this.progressBar && this.progressBar.setNativeProps({style: { width: value * SCREEN_WIDTH }});
  }

  _updateBuffer(value) {
    this.bufferBar && this.bufferBar.setNativeProps({style: { width: value * SCREEN_WIDTH }});
  }
